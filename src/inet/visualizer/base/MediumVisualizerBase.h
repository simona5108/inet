...
class INET_API MediumVisualizerBase : public VisualizerBase, public cListener
{
  ...
  protected:
    ...
    std::map<int /*ITransmissionId*/, Ptr<const math::IFunction<WpHz, math::Domain<m, m, m, simsec, Hz>>>> signalPowerDensityFunctions;
    std::map<int /*ITransmissionId*/, Ptr<math::SummedFunction<WpHz, math::Domain<m, m, m, simsec, Hz>>>> noisePowerDensityFunctions;
