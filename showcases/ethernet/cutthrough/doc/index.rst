...
The new composable/layered Ethernet model supports cut-through switching. This showcase demonstrates cut-through switching, and compares its delay with store-and-forward switching.
...
The example simulation contains two :ned:`StandardHost`'s connected by two :ned:`EthernetSwitch`'es:
